    ...
    export default {
        ...
        methods: {
          ...
          async getUserLoginTotal () {
            ...
            let data = this.postdata('SysApi/v1/findUserLoginTotal')

            if(!data.data) {return}

            if (data.data.status === 200) {
               this.userName = data.data.data[0].name
               this.loginTotal = data.data.data[0].total
            } else {
          ...
          async getUserReqTotal () {
            ...
            let data = this.postdata('SysApi/v1/findUserReqTotal')
            ...
            if (data.data.status === 200) {
               this.arrNa = data.data.data[0].arrName
               this.reqData1 = data.data.data[0].metlist
               this.reqData2 = data.data.data[0].usrlist
            } else {
              const h = this.$createElement;
              this.$notify({
                title: '没有权限查看访问统计',

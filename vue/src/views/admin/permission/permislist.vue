    ...
    <el-row>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item>
                    <el-button type="primary" class="el-icon-search" :loading="selLoading" v-on:click="getFormData">查询
                    </el-button>
                </el-form-item>
                <el-form-item>
        ...
        <!--列表-->
        <el-col>
            <el-table :data="formData" v-loading="listLoading" element-loading-text="拼命加载中"
                ...
                <div style="width:80%;">
                    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" :inline="false"
                        ...
                        <el-form-item label="名称" prop="name">
                            <el-input type="text" placeholder="菜单名称" auto-complete="off"
                                      v-model="ruleForm.name"></el-input>
                        </el-form-item>
                        <el-form-item label="地址" prop="url">
                            <el-input type="text" placeholder="url地址" auto-complete="off"
...
// 查询菜单
            async getFormData() {
                ...
                let data = this.postdata('PermisApi/v1/findPermissionByPage', params)
                if (!data.data) {
...
// 新增用户
            async addPermis() {
                ...
                let params = {
                    ...
                    lastId: this.ruleForm.baseType
                }
                let data = this.postdata('PermisApi/v1/addPermissions', params)
                if (!data.data) {
                    return
                }
...
// 删除用户
            async delPermis() {
                ...
                let data = this.postdata('PermisApi/v1/delPermis', params)
...
// 查询菜单
            async getCboData() {
                ...
                let params = {
                    id: 'd73d7a9c471f4aba884e79152cb1ace0'
                }
                let data = this.postdata('SysApi/v1/findAttributeDetailByAttrId', params)
...
// 查询菜单
            async getBaseCboData(val) {
                ...
                let data = this.postdata('PermisApi/v1/findLastPermissionByType', params)
